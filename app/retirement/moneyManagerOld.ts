...
//   //income
//   {
//     payment: "payPerMonthKepa",
//     amount: biWeeklyToMonthly(2503.53),
//     type: MoneyType.Income,
//   },
//   {
//     payment: "payPerMonthFitri",
//     amount: biWeeklyToMonthly(2471.12),
//     type: MoneyType.Income,
//   },
//   { payment: "gekelerRental", amount: 1800 /*Taxes*/, type: MoneyType.Income },
//   //investments
//   {
//     payment: "SoFiAutoInvest",
//     amount: 6500,
//     type: MoneyType.PostTaxInvestments,
//   },
//   {
//     payment: "m1FinaceIndividual",
//     amount: 6500,
//     type: MoneyType.PostTaxInvestments,
//   },
//   {
//     payment: "m1FinanceRoth",
//     amount: weeklyToMonthly(0),
//     type: MoneyType.PostTaxInvestments,
//   },
//   {
//     payment: "Kepa 401k",
//     amount: biWeeklyToMonthly(724.04 + 193.08),
//     type: MoneyType.PreTaxInvestments,
//   }, // 724.04 + 193.08 match
//   {
//     payment: "Fitri 401k",
//     amount: biWeeklyToMonthly(346.15 + 169.23),
//     type: MoneyType.PreTaxInvestments,
//   }, // 346.15 + 169.23 match
//   //employee stock
...
//   {
//     payment: "Kepa RSU",
//     amount: RSUAsMonthly(45000, 55000),
//     type: MoneyType.EmployeeStock,
//   },
//   {
//     payment: "Fitri RSU",
//     amount: RSUAsMonthly(45000, 45000),
//     type: MoneyType.EmployeeStock,
//   },
//   //Mortgage
//   {
//     payment: "mortgagePaymentGekeler",
//     amount: -851.95,
//     type: MoneyType.Mortgage,
//   },
//   { payment: "hoaGekeler", amount: -311, type: MoneyType.Mortgage },
//   {
//     payment: "mortgagePaymentBendRidge",
//     amount: -3248.99,
//     type: MoneyType.Mortgage,
//   },
...
// ): number {
//   let monthsInPlan = 48;
//   let savedAfterTaxes = 0.6;

//   return (
//     ((planOne + planTwo + planThree + planFour) / monthsInPlan) *
//     savedAfterTaxes
//   );
// }
...
//     if (
//       payment.type === MoneyType.Income ||
//       payment.type === MoneyType.EmployeeStock
//     )
//       postTaxIncome += payment.amount;
//   }
...
//     switch (payment.type) {
//       case MoneyType.EmployeeStock ||
//         MoneyType.PostTaxInvestments ||
//         MoneyType.PreTaxInvestments:
...
// console.log(
//   `loose change to play with after investments and bills: ${spendingMoney(payments).toFixed(2)}`,
// );
// console.log(
//   `Total Invested Per Month: ${investmentMoney(payments).toFixed(2)}`,
// );
