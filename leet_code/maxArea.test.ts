...
describe("testing template", () => {
  //Basic parsing
  test("case 1", () => {
    expect(reverse([1, 8, 6, 2, 5, 4, 8, 3, 7])).toBe(49)
  })

  test("case 2", () => {
    expect(reverse([1,1])).toBe(1)
  })

  test("case 3", () => {
    expect(reverse([0,0])).toBe(0)
  })
  ...
  test("case 4", () => {
    ...
    expect(reverse(array)).toBe(3182)
  })
  ...
  test("case 5", () => {
    ...
    expect(reverse(array)).toBe(1055530)
  })

  test("case 6", () => {
    const array = [8,7,2,1]
    expect(reverse(array)).toBe(7)
  })
})

function reverse(heights: number[]): number {
